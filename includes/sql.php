...
function page_require_level($require_level)
{
  ...
  // elseif ($login_level['group_status'] === false) :
  //   $session->msg('d', 'This level user has been bannned!');
...
function get_available_quantity_sales($p_id)
{
  ...
  $sql = "SELECT SUM(qty) AS total_sold FROM sales WHERE product_id = '{$p_id}'";
  $result = find_by_sql($sql);
...
function get_products_low_quantity_percentage($threshold)
{
  ...
  foreach ($products as $product) {
    $percentage = calculate_quantity_percentage($product['quantity'], $product['init_quantity']);
